...
def handle_c20_log(path, tpl_urls, comments_dict):
    '''
    分析c20日志
    :param path:
    :param tpl_urls:
...
if __name__ == '__main__':
    ...
    tpl_doc = DATA_PATH + '/c20Urls.php'
    log_path = DATA_PATH + '/c20.access.log'
    tpl_urls, comments_dict = handle_url_doc(tpl_doc)
    stat_url = handle_c20_log(log_path, tpl_urls, comments_dict)
    end_time = time.time()
